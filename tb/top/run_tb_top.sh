...
vsim -c -coverage -voptargs="+cover=bces" work.tb_top -do "coverage save -onexit reports/global_cov.ucdb; run -all; quit"
vcover report -file reports/rapport_global.txt reports/global_cov.ucdb
