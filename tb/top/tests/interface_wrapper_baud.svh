...
begin
    ...
    set_bus_a({8'h10, 1'b1});               // baud_div_val=0x10, baud_enable=1
    ...
    set_bus_a({8'h20, 1'b1});               // baud_div_val=0x20, baud_enable=1
    ...
    set_bus_a({8'h08, 1'b1});               // baud_div_val=0x08, baud_enable=1
    ...
    set_bus_a({8'h00, 1'b0});               // baud_enable=0
