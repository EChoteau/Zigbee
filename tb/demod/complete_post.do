...
vlog -incr -sv -work lib_SYNTH +acc ../../asic/synth/demod/netlist/demod_system_complete.v
vlog -incr -sv -work lib_SYNTH +acc tb_all.sv

vsim -voptargs=+acc lib_SYNTH.tb_receiver_system \
     -sdfmax /tb_receiver_system/dut=../../asic/synth/demod/netlist/demod_system_complete.sdf \
