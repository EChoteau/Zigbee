...
vlog -incr -sv -work lib_SYNTH +acc asic/pnr/output_data/cordic_system_top/cordic_system_postroute.v
vlog -incr -sv -work lib_SYNTH +acc tb/cordic/complete_tb.sv

vsim -voptargs=+acc lib_SYNTH.complete_tb \
     -sdfmax /complete_tb/dut=asic/pnr/output_data/cordic_system_top/cordic_system_postroute.sdf \
