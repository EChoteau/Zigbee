...
setMetalFill -layer POLY1 -minDensity 14 -maxDensity 80 -windowSize {200 200} -windowStep {100 100}
setMetalFill -layer MET2  -minDensity 30 -maxDensity 80 -windowSize {200 200} -windowStep {100 100}
