...
set_load -pin_load $std_load_best -min [get_ports {i_cfg_top[*]}]
set_load -pin_load $std_load_best -min [get_ports {i_cfg[*]}]
set_load -pin_load $std_load_best -min [get_ports {i_bus_in[*]}]
