...
## DEBUG Signals
set_max_capacitance $max_cap_best [get_ports {o_dbg_tx_fifo_data[*]}]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_fifo_push"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_fifo_full"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_fifo_pop"]
set_max_capacitance $max_cap_best [get_ports {o_dbg_tx_fifo_q[*]}]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_fifo_rd_valid"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_fifo_empty"]
set_max_capacitance $max_cap_best [get_ports {o_dbg_rx_fifo_data[*]}]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_fifo_push"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_fifo_full"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_fifo_pop"]
set_max_capacitance $max_cap_best [get_ports {o_dbg_rx_fifo_q[*]}]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_fifo_empty"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_ovf_pulse"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_tick"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_path_en"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_path_en"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_global_en"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_start"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_enable"]
set_max_capacitance $max_cap_best [get_ports {o_dbg_div_val[*]}]
set_max_capacitance $max_cap_best [get_ports "o_dbg_tx_und_err"]
set_max_capacitance $max_cap_best [get_ports "o_dbg_rx_ovf_err"]
